...
void
Java_org_videolan_libvlc_Media_nativeSetVideoFormat(JNIEnv *env, jobject thiz, 
    ...
    LOGE("my set video format called");
...
static void unlock(void *data, void *id, void * const * p_pixels) {
    LOGE("my unlock called");
}

static void display(void *data, void *id) {
    LOGE("my display called");
}

void Java_org_videolan_libvlc_Media_nativeSetVideoCallback(JNIEnv *env, jobject thiz) {
    vlcjni_object *p_obj = VLCJniObject_getInstance(env, thiz);
    ...
    LOGE("my set video callback called");
